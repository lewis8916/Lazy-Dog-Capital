...
export async function submitForm(endpoint, payload) {
  ...
  // Routes answer 200 with ok:false when delivery failed but the request was
  // understood — a 5xx would be swapped for the CDN's HTML error page and the
  // message below would never reach the person.
