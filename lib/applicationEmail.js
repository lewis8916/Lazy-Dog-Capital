        ...
        ${
          d.signed_record
            ? section("Electronic Signature Record", [
                ["Consent given", "Yes — agreed to sign electronically"],
                ["Received at", `${d.signed_record.receivedAt} (UTC)`],
                ["IP address", d.signed_record.ip],
                ["Browser", d.signed_record.userAgent],
              ])
            : ""
        }
